...
const (
	...
	CodeAdminAnalyticsAccessDenied    = "ADMIN_ANALYTICS_ACCESS_DENIED"
	CodeAdminAuditAccessDenied        = "ADMIN_AUDIT_ACCESS_DENIED"
	CodeAdminAnalyticsRangeInvalid    = "ADMIN_ANALYTICS_RANGE_INVALID"
	CodeAdminAuditLogNotFound         = "ADMIN_AUDIT_LOG_NOT_FOUND"
	CodeAdminAuditFilterConflict      = "ADMIN_AUDIT_FILTER_CONFLICT"
